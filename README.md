...
<head>
  ...
  <title> Mo Chroí, Will you be my Valentine?</title>
...
<body>
  ...
  <main class="card">
    ...
    <h1>Kate Mooney will you be my valentine?</h1>
    ...
    <!-- HINT -->
    <div class="hint" id="hint">“No” it will infect your device, don't click  😈</div>
